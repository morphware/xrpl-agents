...
class XRPLGetLatestXRPTransactionTool(BaseCustomTool, BaseTool):
    """
    Tool for retrieving the latest transaction of an XRPL account.
    Input should be a valid XRPL account address.
    """
    name: ClassVar[str] = "XRPLGetLatestXRPTransaction"
    ...
    async def _arun(self, tool_input: str) -> str:
        ...
        raise NotImplementedError("Async execution is not supported for XRPLGetLatestXRPTransactionTool.")

if __name__ == "__main__":
    tool = XRPLGetLatestXRPTransactionTool()
    # Example usage:
